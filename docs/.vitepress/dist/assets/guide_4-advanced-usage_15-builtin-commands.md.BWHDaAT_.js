import{_ as a,H as n,f as i,i as p}from"./chunks/framework.DIv0Dgmf.js";const k=JSON.parse('{"title":"第十五章：Command 命令","description":"熟练使用内置命令和自定义命令","frontmatter":{"title":"第十五章：Command 命令","description":"熟练使用内置命令和自定义命令"},"headers":[],"relativePath":"guide/4-advanced-usage/15-builtin-commands.md","filePath":"guide/4-advanced-usage/15-builtin-commands.md"}'),e={name:"guide/4-advanced-usage/15-builtin-commands.md"};function l(t,s,d,c,o,h){return n(),i("div",null,[...s[0]||(s[0]=[p(`<h1 id="第十五章-command-命令" tabindex="-1">第十五章：Command 命令 <a class="header-anchor" href="#第十五章-command-命令" aria-label="Permalink to &quot;第十五章：Command 命令&quot;">​</a></h1><div class="tip custom-block"><p class="custom-block-title">学习目标</p><p>学完这章，你会熟练使用 Claude Code 的内置命令和自定义命令，提高工作效率。</p></div><h2 id="命令与-skill-的区别" tabindex="-1">命令与 Skill 的区别 <a class="header-anchor" href="#命令与-skill-的区别" aria-label="Permalink to &quot;命令与 Skill 的区别&quot;">​</a></h2><p>很多初学者容易混淆 <strong>命令（Command）</strong> 和 <strong>Skill</strong>：</p><table tabindex="0"><thead><tr><th>维度</th><th>命令 (Command)</th><th>Skill (技能)</th></tr></thead><tbody><tr><td><strong>触发方式</strong></td><td><code>/命令名</code></td><td><code>/skill名</code></td></tr><tr><td><strong>实现形式</strong></td><td>纯文本文件</td><td>目录 + SKILL.md + 可选代码</td></tr><tr><td><strong>复杂程度</strong></td><td>简单文本替换</td><td>复杂 AI 工作流</td></tr><tr><td><strong>适用场景</strong></td><td>重复文本/指令</td><td>复杂可复用工作流</td></tr><tr><td><strong>存储位置</strong></td><td><code>.claude/commands/</code></td><td><code>.claude/skills/</code></td></tr></tbody></table><p><strong>简单理解</strong>：</p><ul><li><strong>命令</strong> = 快捷键，快速执行固定文本</li><li><strong>Skill</strong> = 工具包，封装复杂能力</li></ul><h2 id="内置命令" tabindex="-1">内置命令 <a class="header-anchor" href="#内置命令" aria-label="Permalink to &quot;内置命令&quot;">​</a></h2><p>输入 <code>/</code> 可以看到所有可用命令：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/ask      /plan      /review    /test</span></span>
<span class="line"><span>/complete /undo      /retry     /clear</span></span></code></pre></div><h3 id="常用内置命令详解" tabindex="-1">常用内置命令详解 <a class="header-anchor" href="#常用内置命令详解" aria-label="Permalink to &quot;常用内置命令详解&quot;">​</a></h3><h4 id="_1-ask-—-快速提问" tabindex="-1">1. <code>/ask</code> — 快速提问 <a class="header-anchor" href="#_1-ask-—-快速提问" aria-label="Permalink to &quot;1. \`/ask\` — 快速提问&quot;">​</a></h4><p>直接问一个问题，不需要在代码库上下文中：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/ask 什么是 TypeScript 的泛型？</span></span></code></pre></div><p><strong>使用场景：</strong></p><ul><li>快速查概念</li><li>临时问答</li><li>不需要看代码的简单问题</li></ul><h4 id="_2-plan-—-生成任务计划" tabindex="-1">2. <code>/plan</code> — 生成任务计划 <a class="header-anchor" href="#_2-plan-—-生成任务计划" aria-label="Permalink to &quot;2. \`/plan\` — 生成任务计划&quot;">​</a></h4><p>让 Claude 分析代码库，生成修改计划：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/plan</span></span>
<span class="line"><span>帮我重构 auth 模块，把 session 改成 JWT</span></span></code></pre></div><p>Claude 会：</p><ol><li>分析现有代码结构</li><li>生成修改步骤</li><li>等待你确认后执行</li></ol><h4 id="_3-review-—-代码审查" tabindex="-1">3. <code>/review</code> — 代码审查 <a class="header-anchor" href="#_3-review-—-代码审查" aria-label="Permalink to &quot;3. \`/review\` — 代码审查&quot;">​</a></h4><p>对当前分支的代码进行全面审查：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/review</span></span></code></pre></div><p>Claude 会：</p><ol><li>检查代码质量问题</li><li>发现潜在 bug</li><li>给出优化建议</li></ol><h4 id="_4-test-—-生成测试" tabindex="-1">4. <code>/test</code> — 生成测试 <a class="header-anchor" href="#_4-test-—-生成测试" aria-label="Permalink to &quot;4. \`/test\` — 生成测试&quot;">​</a></h4><p>为当前代码生成测试用例：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/test</span></span>
<span class="line"><span>帮我给这个函数写单元测试</span></span></code></pre></div><h4 id="_5-complete-—-标记完成" tabindex="-1">5. <code>/complete</code> — 标记完成 <a class="header-anchor" href="#_5-complete-—-标记完成" aria-label="Permalink to &quot;5. \`/complete\` — 标记完成&quot;">​</a></h4><p>标记任务完成：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/complete</span></span></code></pre></div><h4 id="_6-undo-—-撤销上一步" tabindex="-1">6. <code>/undo</code> — 撤销上一步 <a class="header-anchor" href="#_6-undo-—-撤销上一步" aria-label="Permalink to &quot;6. \`/undo\` — 撤销上一步&quot;">​</a></h4><p>撤销 Claude 最近的操作：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/undo</span></span></code></pre></div><h4 id="_7-retry-—-重试" tabindex="-1">7. <code>/retry</code> — 重试 <a class="header-anchor" href="#_7-retry-—-重试" aria-label="Permalink to &quot;7. \`/retry\` — 重试&quot;">​</a></h4><p>让 Claude 重新思考刚才的回答：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/retry</span></span>
<span class="line"><span>上一个方案太复杂了，换个简单的</span></span></code></pre></div><h4 id="_8-clear-—-清空对话" tabindex="-1">8. <code>/clear</code> — 清空对话 <a class="header-anchor" href="#_8-clear-—-清空对话" aria-label="Permalink to &quot;8. \`/clear\` — 清空对话&quot;">​</a></h4><p>清空当前对话历史：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/clear</span></span></code></pre></div><h4 id="_9-init-—-初始化项目" tabindex="-1">9. <code>/init</code> — 初始化项目 <a class="header-anchor" href="#_9-init-—-初始化项目" aria-label="Permalink to &quot;9. \`/init\` — 初始化项目&quot;">​</a></h4><p>在当前目录创建 Claude Code 配置文件：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/init</span></span></code></pre></div><h4 id="_10-claude-—-查看版本信息" tabindex="-1">10. <code>/claude</code> — 查看版本信息 <a class="header-anchor" href="#_10-claude-—-查看版本信息" aria-label="Permalink to &quot;10. \`/claude\` — 查看版本信息&quot;">​</a></h4><p>查看 Claude Code 版本：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>/claude</span></span></code></pre></div><h2 id="自定义命令" tabindex="-1">自定义命令 <a class="header-anchor" href="#自定义命令" aria-label="Permalink to &quot;自定义命令&quot;">​</a></h2><p>除了内置命令，你还可以创建自定义命令。</p><h3 id="什么是自定义命令" tabindex="-1">什么是自定义命令 <a class="header-anchor" href="#什么是自定义命令" aria-label="Permalink to &quot;什么是自定义命令&quot;">​</a></h3><p>自定义命令是将常用的文本或指令封装成快捷方式，方便重复使用。</p><p><strong>适用场景</strong>：</p><ul><li>固定格式的代码模板</li><li>常用的 Git 操作序列</li><li>重复性的文本输入</li></ul><h3 id="创建自定义命令" tabindex="-1">创建自定义命令 <a class="header-anchor" href="#创建自定义命令" aria-label="Permalink to &quot;创建自定义命令&quot;">​</a></h3><h4 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h4><p><strong>项目级</strong>（纳入 Git，团队共享）：</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>项目根目录/</span></span>
...
<span class="line"></span>
<span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">export</span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;"> function</span><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;"> ComponentName</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">({ </span><span style="--shiki-light:#E36209;--shiki-dark:#FFAB70;">props</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> }) {</span></span>
